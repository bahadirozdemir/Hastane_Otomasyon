...
<?php 
 ...
 $menusorgu = mysqli_query($baglan,"update hasta_uye_olur set mail_adres='$mail' where hasta_id='$tc'");
...
<h1 style="margin:20px 0 0 120px">Mail Adresiniz Başarıyla Güncellendi.</h1>
